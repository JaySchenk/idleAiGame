...
describe('UnlockSystem', () => {
  ...
  describe('Resource Conditions', () => {
    it('passes when resource amount meets minimum requirement', () => {
      const conditions: UnlockCondition[] = [{ type: 'resource', resourceId: 'hcu', minAmount: 50 }]
    ...
    it('handles missing resource ID', () => {
      const conditions: UnlockCondition[] = [{ type: 'resource', minAmount: 50 }]
  ...
  describe('Generator Conditions', () => {
    ...
    it('handles missing generator ID', () => {
      const conditions: UnlockCondition[] = [{ type: 'generator', minOwned: 5 }]
  ...
  describe('Upgrade Conditions', () => {
    it('passes when upgrade is purchased', () => {
      ...
      const conditions: UnlockCondition[] = [{ type: 'upgrade', upgradeId: 'testUpgrade' }]
    ...
    it('handles missing upgrade ID', () => {
      const conditions: UnlockCondition[] = [{ type: 'upgrade' }]
    ...
    it('handles non-existent upgrade', () => {
      const conditions: UnlockCondition[] = [{ type: 'upgrade', upgradeId: 'nonexistent' }]
  ...
  describe('Narrative Conditions', () => {
    it('passes when narrative is viewed', () => {
      ...
      const conditions: UnlockCondition[] = [{ type: 'narrative', narrativeId: 'testNarrative' }]
    ...
    it('handles missing narrative ID', () => {
      const conditions: UnlockCondition[] = [{ type: 'narrative' }]
    ...
    it('handles non-existent narrative', () => {
      const conditions: UnlockCondition[] = [{ type: 'narrative', narrativeId: 'nonexistent' }]
  ...
  describe('Prestige Conditions', () => {
    it('passes when prestige level meets minimum', () => {
      const conditions: UnlockCondition[] = [{ type: 'prestige', minPrestigeLevel: 1 }]
    ...
    it('fails when prestige level below minimum', () => {
      const conditions: UnlockCondition[] = [{ type: 'prestige', minPrestigeLevel: 5 }]
    ...
    it('handles missing prestige level', () => {
      const conditions: UnlockCondition[] = [{ type: 'prestige' }]
  ...
  describe('Time Conditions', () => {
    it('passes when play time meets minimum', () => {
      const conditions: UnlockCondition[] = [{ type: 'time', minPlayTime: 3000 }]
    ...
    it('fails when play time below minimum', () => {
      const conditions: UnlockCondition[] = [{ type: 'time', minPlayTime: 10000 }]
    ...
    it('handles missing play time', () => {
      const conditions: UnlockCondition[] = [{ type: 'time' }]
    ...
    it('handles no game start time', () => {
      ...
      const conditions: UnlockCondition[] = [{ type: 'time', minPlayTime: 1000 }]
