...
export const GAME_START: NarrativeEvent = {
  id: 'gameStart',
...
export const FIRST_CLICK: NarrativeEvent = {
  id: 'firstClick',
...
export const FIRST_GENERATOR: NarrativeEvent = {
  id: 'firstGenerator',
...
export const CONTENT_FLOOD: NarrativeEvent = {
  id: 'contentFlood',
...
export const CORPORATE_INTEREST: NarrativeEvent = {
...
export const FIRST_UPGRADE: NarrativeEvent = {
  id: 'firstUpgrade',
...
export const MASS_SCALE: NarrativeEvent = {
  id: 'massScale',
...
export const SOCIAL_MEDIA_TAKEOVER: NarrativeEvent = {
...
export const FIRST_PRESTIGE: NarrativeEvent = {
  id: 'firstPrestige',
...
export const POLITICAL_INFLUENCE: NarrativeEvent = {
...
export const CULTURAL_COLLAPSE: NarrativeEvent = {
  id: 'culturalCollapse',
...
export const SECOND_PRESTIGE: NarrativeEvent = {
  id: 'secondPrestige',
...
export const FINAL_REALIZATION: NarrativeEvent = {
  id: 'finalRealization',
